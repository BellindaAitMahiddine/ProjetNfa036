...
%>
       ...
       <br>
      <p> <input type="number" id="legumes" name="legumes" required="required"/> <label for ="legumes"> gramme </label>  </p>
      
       <br>
       <br>
       <h1> Fruits : </h1>
       <p>Quelle quantit&eacute journali&egravere consommez-vous ? <br>A titre indicatif : 1 pomme = 150g, fruits cuits ou crus, en compote ou entiers!</p>
       <br>
       <p><input type="number" id="fruis" name="fruits"required="required" /> <label for="fruits"> gramme </label>  </p>
       
       <br>
       <p> Mettez vous un point d'honneur &agrave consommer des fruits ou l&eacutegumes de saison ? <p>
       <p><input type="radio" name="saison" value="1" id="1"required="required"/> <label for="1">oui  </label>
       <input type="radio" name="saison" value="2" id="2" required="required"/> <label for="2">non  </label></p>
       <br>
       <br>

       <h1> Bio</h1>
       <p><label for="bio">Consommez-vous des produits biologique ?</label>
         <select name="bio" id="bio" placeholder="Choississez une frequence"required="required"> 
          ...
          <h1>Viandes - Oeufs - Poisson :</h1>
          <p>A titre indicatif : 1 oeuf = 50g, un steack hach&eacute/pav&eacute de saumon : 120g</p>
          
          <p><input type="number" id="viandes" name="viandes" required="required"/> <label for="viandes"> grammes </label> </p> 
          <br>
          <br> 

          <h1> F&eacuteculents : </h1>
          ...
          <p><input type="number" id="feculents" name="feculents"required="required" />   <label for="feculent"> gramme </label> </p> 
          <br>
          <p> Consommer des l&eacutegumes secs (poids chiche, lentilles, haricot...) ? <p>
          <p><input type="radio" name="legusecs" value="1" id="1"required="required" /> <label for="oui">Oui  </label>
          <input type="radio" name="legusecs" value="2" id="2" required="required"/> <label for="non">Non</label></p>
          <br>
          <br>
          ...
          <br>
          <h1>Produits laitier</h1>
          <p>Combien de produit laitier consommez-vous par jour :</p>
          <p><input type="radio" name="lait" value="0" id="0" required="required"/> <label for="0">aucun</label><br />
          ...
          <input type="radio" name="lait" value="4" id="4" required="required"/> <label for="4">plus de 3 fois</label></p>
          <br>
          <br>

          <h1>Mati&eacutere grasse :</h1>
          ...
          <p><input type="radio" name="omega3" value="1" id="1" required="required"/> <label for="1">Oui  </label>
          <input type="radio" name="omega3" value="2" id="2" required="required"/> <label for="2">Non</label><br /></p>
          ...
          <p><input type="radio" name="mgrasse" value="3" id="3" required="required"/> <label for="3">A chaque repas</label><br />
          ...
          <input type="radio" name="mgrasse" value="0" id="0" required="required"/> <label for="0">Jamais ou rarement</label><br /></p>

          <p>Vous arrive t-il de consommez des chips,gateau ap&eacuteritif, friture ? A quelle fr&eacutequence : <p> 
          <p><input type="radio" name="friture" value= "3" id="3" required="required"/> <label for="3">Tous les jours</label><br />
          ...
          <input type="radio" name="friture" value= "0" id="0" required="required"/> <label for="0">Jamais ou Rarement</label><br /></p>

          <br>

          <p><input type="submit" id=valider" name="valider" value="Passez &agrave la derniere etape" /></p>
        </form>
     </section>
  </body>
</html>